...
import 'package:homework2/data/repositories/app_setting/app_settings_repository_mock.dart';
...
List<SingleChildWidget> get devProviders {
  return [
    ...
    ChangeNotifierProvider<AppSettingsState>(create: (_) => AppSettingsState(repository: _mockAppSettingsRepository)..init(),),
  ];
}
